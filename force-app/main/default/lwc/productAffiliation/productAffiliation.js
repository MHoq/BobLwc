...
import getAllProducts from '@salesforce/apex/ProductController1.getAllProducts';
...
const items = [{
        label: "Vendor Catalogue 1", name:"Vendor Catalogue 1",
        type: "Catalogue",
        treeIcon: 'standard:catalog',
        _children: [],
        expanded: false,
    }, {
        label: "Vendor Catalogue 2", name:"Vendor Catalogue 2",
        type: "Catalogue",
        treeIcon: 'standard:catalog',
        _children: [],
        expanded: false,
    }, {
        label: "Vendor Catalogue 3", name:"Vendor Catalogue 3",
        type: "Catalogue",
        treeIcon: 'standard:catalog',
        _children: [],
        expanded: false,
...
export default class ProductAffiliation extends LightningElement {
    ...
    wiredAllProducts({ error, data }) {
        console.log('wiredAllProducts');
        if (data) {
            console.log( 'Wire getAllProducts' + data[0].Name );
            ...
            console.log( 'this.listItems ' + this.listItems[0].value + ' ' + this.listItems[0].label );
    ...
    handleCheckboxChange(event){
        ...
        console.log('============handleCheckboxChange==============' + selectItemTemp);
    ...
    handleDrop(event){        
        ...
        console.log(JSON.parse(droppedItems));
        console.log('==========================' + droppedProductList.length);
        console.log(droppedProductList + ' Item 2 => ' + droppedProductList[1].label);
